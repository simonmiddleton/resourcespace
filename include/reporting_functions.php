...
function do_report($ref,$from_y,$from_m,$from_d,$to_y,$to_m,$to_d,$download=true,$add_border=false)
    ...
    $sql=str_replace("view_title_field_subselect",
    "( SELECT rd.value FROM resource_data rd WHERE rd.resource = r.ref AND rd.resource_type_field = {$view_title_field} LIMIT 1 ) ",$sql);
