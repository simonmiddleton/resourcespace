		...
		<?php if (checkperm("s") && $recent_link) { ?><li class="HeaderLink"><a href="<?php echo $baseurl?>/pages/search.php?search=<?php if ($recent_search_by_days) {echo "&amp;recentdaylimit=" . $recent_search_by_days_default . "&amp;order_by=asadded&amp;sort=desc";} else {echo urlencode("!last".$recent_search_quantity);}?>&order_by=asadded" onClick="return CentralSpaceLoad(this,true);"><?php echo $lang["recent"]?></a></li><?php } ?>
