...
$lang['brand_guidelines_full_width'] = 'Full-width'; # todo: check if in use
$lang['brand_guidelines_half_width'] = 'Half-width'; # todo: check if in use
...
$lang['brand_guidelines_hex_help_txt'] = 'HEX (0-9A-F) can be input with or without "#" in both short and long forms. Examples: #0FA, 0FA, 74B632';
