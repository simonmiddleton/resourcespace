...
$lang["csv_user_import_condition1"]='یقینی بنائیں کہ CSV فائل کو <b>UTF-8</b> انکوڈنگ کے ساتھ انکوڈ کیا گیا ہے۔';
$lang["csv_user_import_condition2"]='CSV فائل میں ایک ہیڈر قطار ہونی چاہیے';
$lang["csv_user_import_condition3"]='کالم(ز) جن کی قدریں <b>کاما( , )</b> شامل ہوں گی، یقینی بنائیں کہ آپ اسے <b>متن</b> کی قسم کے طور پر فارمیٹ کریں تاکہ آپ کو اقتباسات ("") شامل کرنے کی ضرورت نہ ہو۔ جب .csv فائل کے طور پر محفوظ کر رہے ہوں، تو یقینی بنائیں کہ متن کی قسم کے خلیات کو اقتباس کرنے کا آپشن چیک کریں۔';
