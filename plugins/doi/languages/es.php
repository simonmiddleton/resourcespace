...
$lang["doi_info_link"]='en <a target="_blank" href="https://es.wikipedia.org/wiki/Identificador_de_objeto_digital">Identificadores de Objeto Digital (DOI)</a>';
$lang["doi_info_metadata_schema"]='En la registración DOI en DataCite.org se indican en la <a target="_blank" href="https://schema.datacite.org/meta/kernel-3/doc/DataCite-MetadataKernel_v3.1.pdf">Documentación del Esquema de Metadatos de Datacite</a>';
$lang["doi_info_mds_api"]='Las instrucciones sobre la API DOI utilizada por este plugin se encuentran en la <a target="_blank" href="https://support.datacite.org/docs/mds-api-guide">Documentación de la API de Datacite</a>';
...
$lang["doi_info_prefix"]='sobre los prefijos de <a target="_blank" href="https://en.wikipedia.org/wiki/Digital_object_identifier#Nomenclature">DOI</a>';
...
$lang["doi_pref_publicationYear_fields"]='Busca <a target="_blank" href="https://schema.datacite.org/meta/kernel-3/doc/DataCite-MetadataKernel_v3.1.pdf#page=10">PublicationYear</a> en:<br>(En caso de que no se encuentre ningún valor, se utilizará el año de registro.)';
$lang["doi_pref_creator_fields"]='Busca <a style="font-style: italic" target="_blank" href="https://schema.datacite.org/meta/kernel-3/doc/DataCite-MetadataKernel_v3.1.pdf#page=9">Creador</a> en:';
$lang["doi_pref_title_fields"]='Busca <a style="font-style: italic" target="_blank" href="https://schema.datacite.org/meta/kernel-3/doc/DataCite-MetadataKernel_v3.1.pdf#page=9">Título</a> en:';
$lang["doi_setup_default"]='Si no se puede encontrar ningún valor, utilice el <a href="https://schema.datacite.org/meta/kernel-3/doc/DataCite-MetadataKernel_v3.1.pdf#page=38" target="_blank">código estándar</a>:';
...
$lang["doi_successfully_set"]='ha sido establecido';
$lang["doi_not_successfully_set"]='No ha sido establecido';
$lang["doi_sum_of"]='de';
$lang["doi_sum_already_reg"]='El recurso ya tiene un DOI';
...
$lang["plugin-doi-title"]='Identificador de Objeto Digital';
$lang["plugin-doi-desc"]='Genera DOIs para objetos inmutables antes de registrarlos en DataCite para citación persistente.';