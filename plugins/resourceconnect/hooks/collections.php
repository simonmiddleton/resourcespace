...
function HookResourceconnectCollectionsThumblistextra()
	...
	foreach ($thumbs as $thumb)
		...
		<div class="overlay-link-container"><i class="overlay-link fas fa-link fa-2x"></i></div>
		<a href="<?php echo $baseurl ?>/plugins/resourceconnect/pages/view.php?url=<?php echo urlencode($thumb["url"]) ?>&k=<?php echo getval("k","") ?>&col=<?php echo $usercollection ?>" onClick="return ModalLoad(this,true);"><div class="overlay-link-container"><i class="overlay-link fas fa-link fa-2x"></i></div><img border=0 src="<?php echo $thumb["thumb"] ?>" class="CollectImageBorder" /></a></td> 
		</tr></table>
