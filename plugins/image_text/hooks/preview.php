...
function HookImage_textPreviewPreviewimage()
    ...
    if(!in_array($resource['resource_type'], $image_text_restypes) || (int) $resource["has_image"] === 0 || !in_array(strtoupper($ext), $image_text_filetypes) || $use_watermark){return false;}
