...
$lang["openai_gpt_intro"]='Menambahkan metadata yang dihasilkan dengan melewatkan data yang ada ke API OpenAI dengan prompt yang dapat disesuaikan. Dapatkan kunci API Anda dari <a href=\'https://openai.com/api\' target=\'_blank\' >https://openai.com/api</a><br />Lihat https://beta.openai.com/docs/introduction untuk informasi lebih detail.';
...
$lang["openai_gpt_api_key"]='Kunci API OpenAI';
$lang["openai_gpt_model"]='Nama model API yang akan digunakan (misalnya \'text-davinci-003\')';
$lang["openai_gpt_prompt_prefix"]='Awalan peringatan penyelesaian';
$lang["openai_gpt_prompt_return_json"]='Akhiran prompt penyelesaian (untuk mengembalikan JSON untuk bidang daftar tetap)';
$lang["openai_gpt_prompt_return_text"]='Akhiran peringatan penyelesaian (untuk mengembalikan teks untuk bidang teks)';
