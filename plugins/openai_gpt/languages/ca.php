...
$lang["openai_gpt_intro"]='Afegeix metadades generades passant les dades existents a l\'API d\'OpenAI amb una indicació personalitzable. Obtingueu la vostra clau d\'API a <a href=\'https://openai.com/api\' target=\'_blank\' >https://openai.com/api</a><br />Consulteu https://beta.openai.com/docs/introduction per obtenir informació més detallada.';
$lang["property-openai_gpt_prompt"]='Prompt de GPT.';
$lang["property-openai_gpt_input_field"]='Camp d\'entrada GPT';
$lang["openai_gpt_api_key"]='Clau d\'API d\'OpenAI.';
