...
$lang["uploadviaemail-intro"]='Lähettääksesi tiedostoja sähköpostitse, liitä tiedostot viestiin ja lähetä se osoitteeseen <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p> Varmista, että lähetät viestin osoitteesta <b>[fromaddress]</b>, muuten se jätetään huomiotta.</p><p>Huomaa, että viestin AIHE-kenttään kirjoittamasi tulee menemään [subjectfield] kenttään ResourceSpacessa. </p><p> Huomaa myös, että viestin SISÄLTÖ-kenttään kirjoittamasi tulee menemään [bodyfield] kenttään ResourceSpacessa. </p>  <p>Useat tiedostot ryhmitellään kokoelmaksi. Tiedostosi oletusarvoinen käyttöoikeustaso on <b>\'[access]\'</b>, ja arkistointitila <b>\'[archive]\'</b>.</p><p> [confirmation]';
