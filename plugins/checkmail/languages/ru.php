...
$lang["checkmail_resource_type_population"]='<br />(из allowed_extensions)';
$lang["plugin-checkmail-title"]='Проверить почту';
$lang["plugin-checkmail-desc"]='[Расширенный] Позволяет импортировать вложения из электронной почты';