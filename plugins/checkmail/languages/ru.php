...
$lang["uploadviaemail-intro"]='Для загрузки через электронную почту, прикрепите файл(ы) и отправьте письмо на адрес <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p>Убедитесь, что отправляете письмо с адреса <b>[fromaddress]</b>, иначе оно будет проигнорировано.</p><p>Обратите внимание, что все, что находится в ТЕМЕ письма, будет помещено в поле [subjectfield] в ResourceSpace.</p><p>Также обратите внимание, что все, что находится в ТЕЛЕ письма, будет помещено в поле [bodyfield] в ResourceSpace.</p><p>Несколько файлов будут сгруппированы в коллекцию. Ваши ресурсы по умолчанию будут иметь уровень доступа <b>\'[access]\'</b> и статус архива <b>\'[archive]\'</b>.</p><p> [confirmation]';
