...
$lang["uploadviaemail-intro"]='Pour télécharger par e-mail, attachez votre ou vos fichier(s) et envoyez-le(s) à l\'adresse e-mail <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p>Assurez-vous de l\'envoyer depuis <b>[fromaddress]</b>, sinon il sera ignoré.</p><p>Notez que tout ce qui est dans l\'OBJET de l\'e-mail sera placé dans le champ [subjectfield] de ResourceSpace. </p><p> Notez également que tout ce qui est dans le CORPS de l\'e-mail sera placé dans le champ [bodyfield] de ResourceSpace. </p>  <p>Plusieurs fichiers seront regroupés dans une collection. Vos ressources auront un niveau d\'accès par défaut de <b>\'[access]\'</b>, et un statut d\'archivage de <b>\'[archive]\'</b>.</p><p> [confirmation]';
