...
$lang["uploadviaemail-intro"]='Za prijenos putem e-pošte, priložite datoteku(e) i adresirajte e-poštu na <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p>Obavezno je poslati s <b>[fromaddress]</b>, inače će biti ignorirano.</p><p>Imajte na umu da će sve što je u NASLOVU e-pošte biti u polju [subjectfield] u ResourceSpaceu.</p><p>Također imajte na umu da će sve što je u SADRŽAJU e-pošte biti u polju [bodyfield] u ResourceSpaceu.</p><p>Višestruke datoteke bit će grupirane u kolekciju. Vaši resursi će prema zadanim postavkama biti s pristupom <b>\'[access]\'</b> i statusom arhive <b>\'[archive]\'</b>.</p><p> [confirmation]</p>';
