...
$lang["checkmail_configuration"]='Configuración de correo electrónico.';
...
Una vez que se conecte correctamente y comprenda cómo funciona el script, debe configurar una tarea cron para que se ejecute cada uno o dos minutos.<br />Escaneará el buzón de correo y leerá un correo electrónico no leído por ejecución.<br /><br />
...
$lang["checkmail_lastcheck"]='Su cuenta IMAP fue verificada por última vez en [lastcheck].';
$lang["checkmail_cronjobprob"]='Su trabajo programado de cron para revisar el correo electrónico puede no estar funcionando correctamente, ya que han pasado más de 5 minutos desde la última ejecución.<br /><br />
Un ejemplo de trabajo programado de cron que se ejecuta cada minuto:<br />
...
$lang["addresourcesviaemail"]='Agregar por correo electrónico.';
$lang["uploadviaemail"]='Agregar por correo electrónico.';
$lang["uploadviaemail-intro"]='Para subir archivos por correo electrónico, adjunte su(s) archivo(s) y envíe el correo electrónico a <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p>Asegúrese de enviarlo desde <b>[fromaddress]</b>, de lo contrario, será ignorado.</p><p>Tenga en cuenta que cualquier cosa en el ASUNTO del correo electrónico se colocará en el campo [subjectfield] en ResourceSpace.</p><p>También tenga en cuenta que cualquier cosa en el CUERPO del correo electrónico se colocará en el campo [bodyfield] en ResourceSpace.</p><p>Varios archivos se agruparán en una colección. Sus recursos tendrán un nivel de acceso predeterminado de <b>\'[access]\'</b> y un estado de archivo de <b>\'[archive]\'</b>.</p><p>[confirmation]</p>';
$lang["checkmail_confirmation_message"]='Recibirá un correo electrónico de confirmación cuando su correo electrónico sea procesado con éxito. Si su correo electrónico es omitido por razones programáticas (como si se envía desde una dirección incorrecta), el administrador será notificado de que hay un correo electrónico que requiere atención.';
$lang["yourresourcehasbeenuploaded"]='Su recurso ha sido cargado.';
$lang["yourresourceshavebeenuploaded"]='Tus recursos han sido cargados.';
$lang["checkmail_not_allowed_error_template"]='[Nombre completo del usuario] ([nombre de usuario]), con ID [referencia de usuario] y correo electrónico [correo electrónico del usuario] no tiene permisos para cargar archivos por correo electrónico (verifique los permisos "c" o "d" o los usuarios bloqueados en la página de configuración de checkmail). Registrado en: [fecha y hora].';
