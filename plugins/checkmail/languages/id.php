...
$lang["checkmail_resource_type_population"]='(dari allowed_extensions)';
...
$lang["uploadviaemail-intro"]='Untuk mengunggah melalui e-mail, lampirkan file Anda dan alamatkan e-mail ke <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p>Pastikan untuk mengirimkannya dari <b>[fromaddress]</b>, atau akan diabaikan.</p><p>Perhatikan bahwa apa pun yang ada di SUBYEK e-mail akan masuk ke dalam kolom [subjectfield] di ResourceSpace.</p><p> Juga perhatikan bahwa apa pun yang ada di BADAN e-mail akan masuk ke dalam kolom [bodyfield] di ResourceSpace.</p> <p>Berkas-berkas yang diunggah akan dikelompokkan menjadi sebuah koleksi. Sumber daya Anda akan bawaan ke tingkat Akses <b>\'[access]\'</b>, dan status Arsip <b>\'[archive]\'</b>.</p><p> [confirmation]';
