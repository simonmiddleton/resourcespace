...
$lang["uploadviaemail-intro"]='For å laste opp via e-post, legg ved filen(e) og send e-posten til <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p>Sørg for å sende den fra <b>[fromaddress]</b>, ellers vil den bli ignorert.</p><p>Merk at alt i EMNEfeltet i e-posten vil gå inn i feltet [subjectfield] i ResourceSpace.</p><p>Legg også merke til at alt i KROPPEN av e-posten vil gå inn i feltet [bodyfield] i ResourceSpace.</p><p>Flere filer vil bli gruppert i en samling. Ressursene dine vil som standard ha tilgangsnivå <b>\'[access]\'</b>, og arkivstatus <b>\'[archive]\'</b>.</p><p> [confirmation]</p>';
