...
$lang["uploadviaemail-intro"]='Per pujar per correu electrònic, adjunteu el(s) vostre(s) fitxer(s) i adreceu el correu electrònic a <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p>Assegureu-vos d\'enviar-ho des de <b>[fromaddress]</b>, o serà ignorat.</p><p>Tingueu en compte que qualsevol cosa al SUBJECT del correu electrònic anirà al camp [subjectfield] a ResourceSpace.</p><p>També tingueu en compte que qualsevol cosa al BODY del correu electrònic anirà al camp [bodyfield] a ResourceSpace.</p><p>Múltiples fitxers seran agrupats en una col·lecció. Els vostres recursos per defecte tindran un nivell d\'accés <b>\'[access]\'</b>, i un estat d\'arxiu <b>\'[archive]\'</b>.</p><p>[confirmation]</p>';
