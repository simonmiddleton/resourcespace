...
$lang["checkmail_resource_type_population"]='Per favore, tradurre: <br />(da allowed_extensions)';
...
$lang["uploadviaemail-intro"]='Per caricare tramite e-mail, allegare il/i tuo/i file e indirizzare l\'e-mail a <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p>Assicurati di inviarlo da <b>[fromaddress]</b>, altrimenti verrà ignorato.</p><p>Nota che qualsiasi cosa nell\'OGGETTO dell\'e-mail andrà nel campo [subjectfield] in ResourceSpace. </p><p> Nota anche che qualsiasi cosa nel CORPO dell\'e-mail andrà nel campo [bodyfield] in ResourceSpace. </p>  <p>Più file saranno raggruppati in una collezione. Le tue risorse avranno come predefinito un livello di accesso <b>\'[access]\'</b>, e uno stato di archivio <b>\'[archive]\'</b>.</p><p> [confirmation]';
