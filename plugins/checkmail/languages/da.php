...
$lang["checkmail_resource_type_population"]='Tilladte filtyper (fra allowed_extensions)';
...
$lang["uploadviaemail-intro"]='For at uploade via e-mail, vedhæft din(e) fil(er) og adressér e-mailen til <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p>Sørg for at sende den fra <b>[fromaddress]</b>, ellers vil den blive ignoreret.</p><p>Bemærk, at alt i EMNET på e-mailen vil blive placeret i feltet [subjectfield] i ResourceSpace.</p><p>Bemærk også, at alt i INDHOLDET af e-mailen vil blive placeret i feltet [bodyfield] i ResourceSpace.</p><p>Flere filer vil blive grupperet i en samling. Dine ressourcer vil som standard have en adgangsniveau på <b>\'[access]\'</b> og en arkiveringsstatus på <b>\'[archive]\'</b>.</p><p>[confirmation]</p>';
