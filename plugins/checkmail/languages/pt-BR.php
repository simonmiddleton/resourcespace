...
$lang["uploadviaemail-intro"]='Para enviar arquivos por e-mail, anexe o(s) arquivo(s) e envie para o endereço <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p> Certifique-se de enviar o e-mail de <b>[fromaddress]</b>, caso contrário, ele será ignorado.</p><p>Observe que qualquer coisa no ASSUNTO do e-mail será inserido no campo [subjectfield] no %applicationname%. </p><p> Observe também que qualquer coisa no CORPO do e-mail será inserido no campo [bodyfield] no %applicationname%. </p>  <p> Vários arquivos serão agrupados em uma coleção. Seus recursos terão como padrão o nível de acesso <b>\'[access]\'</b> e o status de arquivo morto <b>\'[archive]\'</b>.</p><p> [confirmation]';
