...
$lang["checkmail_resource_type_population"]='Erlaubte Erweiterungen (von allowed_extensions)';
...
$lang["uploadviaemail-intro"]='Um per E-Mail hochzuladen, fügen Sie Ihre Datei(en) als Anhang hinzu und senden Sie die E-Mail an <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p>Stellen Sie sicher, dass Sie sie von <b>[fromaddress]</b> senden, sonst wird sie ignoriert.</p><p>Beachten Sie, dass alles im BETREFF der E-Mail in das Feld [subjectfield] in ResourceSpace übernommen wird. </p><p>Beachten Sie auch, dass alles im TEXTKÖRPER der E-Mail in das Feld [bodyfield] in ResourceSpace übernommen wird. </p>  <p>Mehrere Dateien werden zu einer Sammlung gruppiert. Ihre Ressourcen werden standardmäßig auf den Zugriffslevel <b>\'[access]\'</b> und den Archivstatus <b>\'[archive]\'</b> gesetzt.</p><p> [confirmation]';
