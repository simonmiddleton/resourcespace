...
$lang["uploadviaemail-intro"]='Pre nahratie cez e-mail, priložte svoj(e) súbor(y) a adresujte e-mail na <b><a href=\'mailto:[toaddress]\'>[toaddress]</a></b>.</p> <p>Uistite sa, že ho posielate z <b>[fromaddress]</b>, inak bude ignorovaný.</p><p>Všimnite si, že čokoľvek v PREDMETE e-mailu sa dostane do poľa [subjectfield] v ResourceSpace.</p><p>Taktiež si všimnite, že čokoľvek v TELE e-mailu sa dostane do poľa [bodyfield] v ResourceSpace.</p><p>Viaceré súbory budú zoskupené do kolekcie. Vaše zdroje budú mať predvolenú úroveň prístupu <b>\'[access]\'</b> a stav archivácie <b>\'[archive]\'</b>.</p><p>[confirmation]</p>';
