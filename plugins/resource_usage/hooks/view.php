...
function HookResource_usageViewCustompanels()
    ...
    if($edit_access)
        {
        ?>    
        <p>&gt;&nbsp;<a href="<?php echo $baseurl_short; ?>plugins/resource_usage/pages/edit.php?resource=<?php echo $ref; ?>" onClick="return CentralSpaceLoad(this, true);"><?php echo $lang['new_usage']; ?></a></p>
        <?php
        }
