...
$lang["action_dates_email_range_restrict"]='Los siguientes recursos están programados para restringirse en un plazo de %%DAYSMIN a %%DAYSMAX días.';
...
$lang["action_dates_email_range"]='Los siguientes recursos están programados para restringirse y/o cambiar de estado en un plazo de %%DAYSMIN a %%DAYSMAX días.';
