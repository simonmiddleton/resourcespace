...
$lang['tms_link_write_to_debug_log'] = "Include script progress is system debug log (requires debug logging configured separately). Caution: Will cause rapid growth of debug log file.";