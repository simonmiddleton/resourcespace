...
$lang["information-if_you_enable_indexing_below_and_the_field_already_contains_data-you_will_need_to_reindex_this_field"]='Jeśli włączysz indeksowanie poniżej, a pole już zawiera dane, będziesz musiał <strong><a target=_blank href=../tools/reindex_field.php?field=%ref>ponownie zindeksować to pole</a></strong>.';
$lang["property-index_this_field"]='Zaindeksuj to pole.';
$lang["information_index_warning"]='Proszę odnieść się do <strong><a href=\'https://www.resourcespace.com/knowledge-base/resourceadmin/indexing-metadata\' target=\'_blank\'>bazy wiedzy</a></strong> w celu uzyskania szczegółowych informacji na temat indeksowania pól.';
...
$lang["property-inherit_global_fields"]='Dziedzicz pola globalne.';
$lang["information-inherit_global_fields"]='Czy globalne pola powinny być uwzględnione dla tego typu zasobu?';
...
$lang["property-sync_with_field"]='Synchronizuj z polem.';
...
$lang["hiddencollections_hide"]='Ukryj ukryte kolekcje.';
$lang["hiddencollections_show"]='Pokaż ukryte kolekcje.';
...
$lang["emailthemecollectionmessageexternal"]='Wysłał Ci kolekcje zasobów z ResourceSpace za pomocą poczty elektronicznej.';
$lang["emailthememessage"]='Wysłał Ci e-mailem wybór wyróżnionych kolekcji z ResourceSpace, które zostały dodane do Twojej strony "Moje kolekcje".';
...
$lang["resource_custom_access"]='Dostosowany dostęp do zasobów.';
$lang["remove_custom_access_users_groups"]='Użytkownicy i grupy z dostępem niestandardowym.';
...
$lang["createdfromwebuploadertemplate"]='Utworzono jako szablon z przesyłania plików przez przeglądarkę internetową.';
...
$lang["user_autocreated"]='Automatycznie utworzone.';
$lang["user_approved_by"]='Zatwierdzone przez';
$lang["user_autoapproved"]='Automatycznie zatwierdzone.';
...
$lang["synchronise-changes-with-this-field"]='Synchronizuj zmiany z tym polem.';
...
$lang["sharerelatedresources"]='Dołącz powiązane zasoby.<br>Nowa kolekcja zostanie utworzona i udostępniona, jeśli którykolwiek z tych zasobów zostanie wybrany.';
$lang["sharerelatedresourcesaddremove"]='Jeśli udostępniasz powiązane zasoby, zezwól innym użytkownikom na dodawanie/usuwanie zasobów z nowej kolekcji.';
$lang["create_empty_resource"]='Pomiń przesyłanie i utwórz nowy zasób bez powiązanego pliku.';
...
$lang["systemconsole"]='Konsola';
$lang["systemconsoledebuglog"]='Dziennik debugowania.';
$lang["systemconsolememorycpu"]='Pamięć i procesor (CPU)';
$lang["systemconsoledatabase"]='Baza danych.';
$lang["systemconsolesqllogtransactions"]='Dziennik transakcji SQL.';
$lang["systemconsoleactivitylog"]='Dziennik aktywności.';
...
$lang["systemconsoleonfailedtopcommand"]='Nie udało się wykonać polecenia top.';
...
$lang["metadata_first_option_is_default"]='Pierwsza opcja będzie używana jako opcja domyślna dla tego pola. Aby ustawić opcję domyślną dla wszystkich zasobów, które obecnie nie mają wartości dla tego pola, użyj poniższego linku.';
$lang["metadata_populate_default_node_for_empty_values"]='Wypełnij domyślną opcję.';
