...
$lang["information-if_you_enable_indexing_below_and_the_field_already_contains_data-you_will_need_to_reindex_this_field"]='如果您启用下面的索引并且该字段已经包含数据，则需要<strong><a target=_blank href=../tools/reindex_field.php?field=%ref>重新索引此字段</a></strong>。';
$lang["property-index_this_field"]='索引此字段';
$lang["information_index_warning"]='请参考<strong><a href=\'https://www.resourcespace.com/knowledge-base/resourceadmin/indexing-metadata\' target=\'_blank\'>知识库</a></strong>，了解有关字段索引的详细信息。';
...
$lang["property-inherit_global_fields"]='继承全局字段';
$lang["information-inherit_global_fields"]='这个资源类型是否应包括全局字段？';
...
$lang["property-sync_with_field"]='同步字段';
...
$lang["hiddencollections_hide"]='隐藏隐藏的集合';
$lang["hiddencollections_show"]='显示隐藏的集合。';
...
$lang["emailthemecollectionmessageexternal"]='已经通过电子邮件向您发送了来自ResourceSpace的资源集合。';
$lang["emailthememessage"]='已向您发送了一组来自ResourceSpace的特色收藏，这些收藏已添加到您的“我的收藏”页面。';
...
$lang["resource_custom_access"]='资源自定义访问';
$lang["remove_custom_access_users_groups"]='用户和组具有自定义访问权限。';
...
$lang["createdfromwebuploadertemplate"]='从Web上传器创建为模板。';
...
$lang["user_autocreated"]='自动创建的';
$lang["user_approved_by"]='已批准';
$lang["user_autoapproved"]='自动批准';
