...
$lang["property-use_for_find_similar_searching"]="Použite na nájdenie podobného vyhľadávania";
...
$lang["smallthumbs"]="Malé";
$lang["smallthumbstitle"]="Malé miniatúry";
$lang["strip"]="Rad";
...
# Admin
$lang["manageresources"]="Spravovať zdroje";
$lang["overquota"]="Kvóta na disku prekročená; nie je možné pridať ďalšie zdroje";
$lang["managearchiveresources"]="Spravovať archívne prostriedky";
$lang["managethemes"]="Spravovať vybrané zbierky";
$lang["manageresearchrequests"]="Spravovať žiadosti o asistenciu";
$lang["manageusers"]="Spravovať používateľov";
$lang["managecontent"]="Spravovať obsah";
...
$lang["pluginssetup"]="Spravovať doplnky";
...
$lang["similarresources"]="podobné zdroje"; # e.g. 17 similar resources
$lang["similarresource"]="podobný zdroj"; # e.g. 1 similar resource
$lang["nosimilarresources"]="Žiadne podobné zdroje";
...
$lang["searchforsimilarresources"]="Vyhľadať podobné zdroje";
$lang["clicktoviewasresultset"]="Zobraziť tieto zdroje ako výsledky vyhľadávania";
$lang["searchnomatches"]="Bez výsledkov.";
$lang["try"]="Vyskúšať";
$lang["tryselectingallcountries"]="Skúste výbrať <b>všetky</b> krajiny alebo";
$lang["tryselectinganyyear"]="Skúste výbrať <b>ktorýkoľvek rok</b> v zozname rokov alebo";
$lang["tryselectinganymonth"]="Skúste výber <b>ktorýkoľvek mesiac </b> v poli s mesiacmi alebo";
...
$lang["backtoeditmetadata"]="Späť na editáciu zdroja";
...
$lang["managerequestsorders"]="Správa požiadaviek / objednávok";
$lang["editrequestorder"]="Upraviť požiadavku / objednávku";
$lang["requestorderid"]="ID požiadavky / objednávky";
...
$lang['plugins-uploadtext'] = 'Vyberte súbor .rsp, ktorý chcete nainštalovať.';
...
$lang['plugins-rejmultpath'] = 'Archív obsahuje viacero ciest. (Bezpečnostné riziko)';
$lang['plugins-rejrootpath'] = 'Archív obsahuje absolútne cesty. (Bezpečnostné riziko)';
$lang['plugins-rejparentpath'] = 'Archív obsahuje cesty k nadradeným adresárom (../). (Bezpečnostné riziko)';
$lang['plugins-rejmetadata'] = 'Súbor s popisom archívu sa nenašiel.';
$lang['plugins-rejarchprob'] = 'Pri extrahovaní archívu sa vyskytol problém:';
$lang['plugins-rejfileprob'] = 'Nahrané rozšírenie musí byť súbor typu .rsp.';
$lang['plugins-rejremedy'] = 'Ak tomuto rozšíreniu dôverujete, môžete ho nainštalovať ručne, extrahovaním archívu do adresára s rozšíreniami.';
$lang['plugins-uploadsuccess'] = 'Rozšírenie sa úspešne nahralo na server.';
$lang['plugins-headertext'] = 'Doplnky rozširujú funkčnosť ResourceSpace.';
$lang['plugins-legacyinst'] = 'Aktivované v config.php';
$lang['plugins-uploadbutton'] = 'Nahrať doplnok na server';
...
$lang['plugins-didnotwork'] = 'Ospravedlňujeme sa, ale toto nefungovalo. Vyberte platný súbor .rsc súbor pre toto rozšírenie a potom kliknite na tlačidlo \'Nahrať konfiguráciu na server\'.';
$lang['plugins-goodrsc'] = 'Konfigurácia bola nahraná. Uložte ju kliknutím na tlačidlo „Uložiť konfiguráciu“.';
$lang['plugins-badrsc'] = 'Ľutujeme, ale toto nebol platný súbor typu .rsc.';
$lang['plugins-wrongplugin'] = 'Ľutujeme, toto je súbor typu .rsc pre rozšírenie %plugin. Vyberte súbor .rsc pre toto rozšírenie.'; // %plugin is replaced by the name of the plugin being configured.
...
$lang["nowriteaccesstofilestore"]=" Priečinok nie je zapisovateľný";
...
$lang["nowriteaccesstohomeanim"]=" do folder nie je možné zapisovať. Pridajte oprávnenia na zápis pre umožnenie funkcie orezania domácej animácie v doplnku Transformácie.";
...
$lang["no_resourcetypes-collections"] = "Všetky %collectiontypes%"; # Use %COLLECTIONTYPES%, %collectiontypes% or %Collectiontypes% as a placeholder. The placeholder will be replaced with the collectiontype (or $lang["all-collectiontypes"]), using the same case. E.g. "Všetky zbierky%% " -> " Všetky moje zbierky"
...
$lang['page-title_user_group_management'] = "Spravovať skupiny používateľov";
...
# Report management
$lang['page-title_report_management'] = "Spravovať hlásenia/prehľady";
$lang['page-subtitle_report_management'] = "Táto časť sa používa na úpravu systémových hlásení/prehľadov.";
$lang['action-title_create_report_called'] = "Vytvoriť prehľad s názvom ...";
...
# size management
$lang['page-title_size_management'] = "Spravovať veľkosti/rozmery";
...
$lang["resource_types_manage"]      = "Spravovať typy zdrojov";
...
$lang["admin_delete_field_confirm"]="Existujú %%AFFECTEDRESOURCES%% zdrojov s prostriedkami v tomto poli. ID niekoľkých ovplyvnených prostriedkov sú uvedené nižšie. Ak budete pokračovať, metadáta spojené s týmto poľom sa stratia. Naozaj chcete pokračovať v mazaní?";
$lang["admin_resource_type_create"]="Vytvoriť typ prostriedku s názvom ...";
$lang["admin_resource_type_field"]="Spravovať polia metadát";
...
$lang["admin_resource_type_fields"]="Spravovať polia metaúdajov";
...
$lang["resource_type_delete_confirmation"]="Existuje %%RESOURCECOUNT%% zdrojov tohto typu.";
...
$lang['manage_dash_tiles'] = 'Spravovať dlaždice na palubovke';
...
$lang['manage_user_group_dash_tiles']  = 'Spravovať dlaždice palubovky skupiny používateľov';
...
/* Manage slideshows */
$lang["manage_slideshow"] = "Spravovať prezentáciu";
...
$lang["filter_manage"]              = "Spravovať filtre";
...
$lang["property-field_constraint"]="Obmedzenie poľa";
$lang["mycollection"]="Predvolená zbierka";
$lang["modified"]="Modifikovaná";
...
$lang["db-default-encoding"] = "(kódovanie znakov databázy: %encoding)"; # %encoding will be replaced
...
$lang['download_limit_summary'] = "Stiahli ste %% DOWNLOADED %% z celkového limitu %% LIMIT %% zdrojov.";
