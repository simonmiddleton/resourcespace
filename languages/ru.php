...
$lang["information-if_you_enable_indexing_below_and_the_field_already_contains_data-you_will_need_to_reindex_this_field"]='Если вы включите индексацию ниже, и поле уже содержит данные, вам нужно будет <strong><a target=_blank href=../tools/reindex_field.php?field=%ref>переиндексировать это поле</a></strong>.';
$lang["property-index_this_field"]='Индексировать это поле.';
$lang["information_index_warning"]='Пожалуйста, обратитесь к <strong><a href=\'https://www.resourcespace.com/knowledge-base/resourceadmin/indexing-metadata\' target=\'_blank\'>Базе знаний</a></strong> для получения подробной информации о индексации полей.';
...
$lang["property-inherit_global_fields"]='Наследовать глобальные поля.';
$lang["information-inherit_global_fields"]='Следует ли включить глобальные поля для этого типа ресурсов?';
...
$lang["property-sync_with_field"]='Синхронизировать с полем.';
...
$lang["collectionidprefix"]='Идентификатор коллекции (Col_ID)';
$lang["_dupe"]='Пожалуйста, переведите: _dupe.

К сожалению, без контекста я не могу точно перевести это слово. "Dupe" может быть сокращением от "duplicate" (дубликат), что может относиться к дубликату ресурса в системе управления цифровыми активами. Однако, "dupe" также может быть сокращением от "duplication" (дублирование), что может относиться к процессу создания дубликатов ресурсов. Если вы можете предоставить больше контекста, я смогу дать более точный перевод.';
...
$lang["hiddencollections_hide"]='Скрыть скрытые коллекции.';
$lang["hiddencollections_show"]='Показать скрытые коллекции.';
...
$lang["emailcollectionmessageexternal"]='отправил вам по электронной почте коллекцию ресурсов из ResourceSpace.';
...
$lang["emailthemecollectionmessageexternal"]='Отправил вам по электронной почте коллекции ресурсов из ResourceSpace.';
$lang["emailthememessage"]='Отправил вам по электронной почте подборку избранных коллекций из ResourceSpace, которые были добавлены на вашу страницу "Мои коллекции".';
...
$lang["sortorder-asc"]='ASC необходимо перевести в контексте, чтобы я мог точно определить, что это означает в ResourceSpace. Можете ли вы предоставить дополнительную информацию или контекст, в котором используется ASC?';
$lang["sortorder-desc"]='Описание (Description)';
...
$lang["fileoftype"]='Пожалуйста, уточните контекст. "File" может иметь несколько значений в контексте программного обеспечения для управления цифровыми ресурсами.';
$lang["cell-fileoftype"]='Расширение файла %EXTENSION';
$lang["field-fileextension"]='Расширение файла.';
$lang["fileextension-inside-brackets"]='Пожалуйста, переведите: [%EXTENSION]

Расширение файла';
$lang["fileextension"]='Расширение файла.';
...
$lang["resource_custom_access"]='Доступ к настраиваемым ресурсам.';
$lang["remove_custom_access_users_groups"]='Пользователи и группы с настраиваемым доступом.';
...
$lang["createdfromwebuploadertemplate"]='Создано из веб-загрузчика в качестве шаблона.';
...
$lang["user_autocreated"]='Автоматически создано.';
$lang["user_approved_by"]='Утверждено.';
$lang["user_autoapproved"]='Автоматически одобрено.';
...
$lang["hour-abbreviated"]='I\'m sorry, but "HH" is not a string used in ResourceSpace, and it is not clear what it refers to. Can you please provide more context or information about where this string appears in the software?';
...
$lang["notavailableshort"]='N/A can be translated as "н/д" which stands for "нет данных" (no data).';
...
$lang["sharedcollectionaddwarningupload"]='Предупреждение: Выбранная коллекция была разделена с внешними пользователями. Ресурсы, которые вы загружаете, будут доступны этим пользователям. Нажмите "Поделиться" в нижней панели, чтобы управлять внешним доступом к этой коллекции.';
...
$lang["collection_download_tar_applink"]='Не удается открыть TAR-файлы? Получите открытое программное обеспечение 7-zip <a href=\'http://www.7-zip.org/download.html\' target=\'_blank\'>здесь</a>.';
...
$lang["warningdismiss"]='Отменить это предупреждение.';
...
$lang["setup-apiscramblekey"]='Ключ шифрования API.';
...
$lang["setup-if_apiscramblekey"]='Установите ключ перестановки API таким образом, чтобы это была последовательность символов, сложная для угадывания (аналогично паролю). Если вы планируете использовать API, то это очень разумная идея.';
$lang["setup-err_apiscramblekey"]='Если это публичная установка, рекомендуется установить ключ для API-шифрования.';
...
$lang["setup-generaloptions"]='Общие настройки.';
$lang["setup-allow_password_change"]='Разрешить изменение пароля?';
$lang["setup-enable_remote_apis"]='Включить удаленные API?';
$lang["setup-if_allowpasswordchange"]='Разрешить конечным пользователям изменять свои пароли.';
$lang["setup-if_enableremoteapis"]='Разрешить удаленный доступ к плагинам API.';
$lang["setup-allow_account_requests"]='Разрешить пользователям запрашивать учетные записи?';
$lang["setup-display_research_request"]='Отобразить функциональность запроса на исследование?';
$lang["setup-if_displayresearchrequest"]='Позволяет пользователям запрашивать ресурсы через форму, которая отправляется по электронной почте.';
$lang["setup-themes_as_home"]='Использовать страницу рекомендуемых коллекций в качестве домашней страницы?';
$lang["setup-remote_storage_locations"]='Удаленные места хранения.';
$lang["setup-use_remote_storage"]='Использовать удаленное хранилище?';
$lang["setup-if_useremotestorage"]='Отметьте этот флажок, чтобы настроить удаленные места хранения для ResourceSpace. (Для использования другого сервера для файлового хранилища.)';
$lang["setup-storage_directory"]='Директория хранения.';
$lang["setup-if_storagedirectory"]='Куда поместить медиа-файлы. Можно использовать абсолютный путь (/var/www/blah/blah) или относительный путь относительно установки. ВНИМАНИЕ: Не ставьте косую черту в конце.';
$lang["setup-storage_url"]='URL хранилища';
$lang["setup-if_storageurl"]='Где доступен каталог хранения. Может быть абсолютным (http://files.example.com) или относительным от установки. ПРИМЕЧАНИЕ: Без завершающего слэша.';
...
$lang["design-options"]='Варианты дизайна.';
$lang["use-slim-theme"]='Использовать дизайн SlimHeader?';
$lang["setup-if_slimtheme"]='Используйте дизайн SlimHeader вместо оригинального дизайна, чтобы отображать более тонкую строку заголовка с связанным логотипом по умолчанию.';
...
$lang["ppi"]='ППИ (PPI) - это сокращение от "пикселей на дюйм" (pixels per inch), которое используется для измерения разрешения изображения.';
...
$lang["map_osmfrance"]='OSM France (OpenStreetMap France) - ОСМ Франция (Открытая карта улиц Франции)';
...
$lang["map_esri_group"]='ESRI переводится как "Environmental Systems Research Institute" (Институт исследования экологических систем).';
$lang["map_esristreet"]='Улицы.';
$lang["map_esridelorme"]='DeLorme - ДеЛорме';
...
$lang["map_nasagibs_group"]='NASA GIBS переводится как "NASA Global Imagery Browse Services" (Глобальные сервисы просмотра изображений NASA).';
...
$lang["map_mapbox_group"]='Mapbox - это картографическая платформа.';
$lang["map_mapboxid"]='Идентификатор (ID)';
...
$lang["field_ref_and_name"]='%ref% - %name% переводится как %ref% - %name%';
...
$lang["star"]='Звезда.';
$lang["stars"]='Звезды.';
$lang["noupload"]='Нет загрузки.';
$lang["permissions"]='Разрешения.';
$lang["configdefault-title"]='I\'m sorry, I cannot see any text to translate. Please provide me with the English text that needs to be translated to Русский язык.';
$lang["config-title"]='БУДЬТЕ ОСТОРОЖНЫ, чтобы не допустить ошибок в синтаксисе. Если вы повредите этот файл, вам придется исправлять его на стороне сервера!';
...
$lang["ref-title"]='%ref - %title переводится как %ref - %title. Это скорее всего является шаблоном для отображения информации о ресурсе, где %ref представляет собой уникальный идентификатор ресурса, а %title - его заголовок.';
...
$lang["synchronise-changes-with-this-field"]='Синхронизировать изменения с этим полем.';
...
$lang["sharerelatedresources"]='Включить связанные ресурсы.<br>Если какой-либо из них выбран, будет создана новая коллекция и она будет доступна для общего использования.';
$lang["sharerelatedresourcesaddremove"]='Если ресурсы связаны с общим использованием, разрешить другим пользователям добавлять/удалять ресурсы из новой коллекции.';
$lang["create_empty_resource"]='Пропустить загрузку и создать новый ресурс без связанного файла.';
...
$lang["property-orphaned"]='Без родителей (orphaned)';
...
<iframe src="https://www.resourcespace.com/knowledge-base/?from_rs=true" style="width:1235px;height:600px;border:none;margin:-20px;" id="knowledge_base" /> (in Русский язык)

<iframe src="https://www.resourcespace.com/knowledge-base/?from_rs=true" style="width:1235px;height:600px;border:none;margin:-20px;" id="knowledge_base" /> - это код для вставки веб-страницы базы знаний ResourceSpace в ваш сайт.';
...
$lang["plugin_category_api"]='API (интерфейс приложения)';
...
$lang["systemconsole"]='Консоль';
$lang["systemconsoledebuglog"]='Журнал отладки.';
$lang["systemconsolememorycpu"]='Память и ЦПУ.';
$lang["systemconsoledatabase"]='База данных.';
$lang["systemconsolesqllogtransactions"]='Журнал транзакций SQL.';
$lang["systemconsoleactivitylog"]='Журнал активности.';
...
$lang["systemconsoleonfailedtopcommand"]='Не удалось выполнить команду top.';
...
$lang["metadata_first_option_is_default"]='Первый вариант будет использоваться в качестве варианта по умолчанию для этого поля. Чтобы установить вариант по умолчанию для всех ресурсов, у которых в настоящее время отсутствует значение для этого поля, используйте ссылку ниже.';
$lang["metadata_populate_default_node_for_empty_values"]='Заполнить опцию по умолчанию.';
...
$lang["systemconfig_api"]='API (интерфейс приложения)';
