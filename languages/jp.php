...
$lang["information-if_you_enable_indexing_below_and_the_field_already_contains_data-you_will_need_to_reindex_this_field"]='以下のインデックス化を有効にし、フィールドにすでにデータが含まれている場合は、<strong><a target=_blank href=../tools/reindex_field.php?field=%ref>このフィールドを再インデックスする必要があります</a></strong>。';
$lang["property-index_this_field"]='このフィールドをインデックス化する。';
$lang["information_index_warning"]='フィールドインデックスに関する詳細情報については、<strong><a href=\'https://www.resourcespace.com/knowledge-base/resourceadmin/indexing-metadata\' target=\'_blank\'>ナレッジベース</a></strong>を参照してください。';
...
$lang["property-inherit_global_fields"]='グローバルフィールドを継承する';
$lang["information-inherit_global_fields"]='このリソースタイプにグローバルフィールドを含めますか？';
...
$lang["property-sync_with_field"]='フィールドと同期する';
...
$lang["hiddencollections_hide"]='非表示コレクションを非表示にする';
$lang["hiddencollections_show"]='非表示コレクションを表示する';
...
$lang["emailcollectionmessageexternal"]='ResourceSpaceからリソースのコレクションをあなたにメールで送信しました。';
$lang["archivesettings"]='アーカイブ設定';
$lang["archive-zip"]='ZIPの翻訳は「圧縮ファイル」です。';
$lang["archive-7z"]='7Zの翻訳は不要です。7Zはファイル圧縮形式の一種で、ResourceSpaceではサポートされています。';
...
$lang["emailthemecollectionmessageexternal"]='ResourceSpaceからリソースのコレクションをあなたにメールで送信しました。';
$lang["emailthememessage"]='ResourceSpaceから注目のコレクションの選択肢をあなたにメールで送信し、それらが「マイコレクション」ページに追加されました。';
...
$lang["resource_custom_access"]='リソースのカスタムアクセス';
$lang["remove_custom_access_users_groups"]='ユーザーとグループのカスタムアクセス設定';
...
$lang["createdfromwebuploadertemplate"]='Web Uploader からテンプレートとして作成されました。';
...
$lang["user_autocreated"]='自動的に作成されました。';
$lang["user_approved_by"]='承認済み';
$lang["user_autoapproved"]='自動承認されました。';
...
$lang["map_tf_group"]='Thunderforestの翻訳はありません。Thunderforestは、地図タイルプロバイダーの名前です。';
$lang["map_tfapi"]='APIコード';
$lang["map_tfocm"]='OpenCycleMap（OCM）の翻訳は、「オープンサイクルマップ」となります。';
...
$lang["map_stamen_group"]='Stamenの日本語への翻訳は「雄しべ」です。';
...
$lang["enterantispamcode"]='<strong>アンチスパム</strong> <sup>*</sup><br /> 以下のコードを入力してください：';
...
$lang["phpinivalue"]='PHP.INIの値「?」の翻訳をお願いします。';
...
$lang["synchronise-changes-with-this-field"]='このフィールドと変更を同期する。';
...
$lang["sharerelatedresources"]='関連するリソースを含める。<br>これらのいずれかが選択された場合、新しいコレクションが作成され共有されます。';
$lang["sharerelatedresourcesaddremove"]='関連するリソースを共有する場合、他のユーザーが新しいコレクションからリソースを追加/削除できるようにします。';
$lang["create_empty_resource"]='アップロードをスキップし、関連ファイルのない新しいリソースを作成します。';
...
$lang["metadata_first_option_is_default"]='最初のオプションは、このフィールドのデフォルトオプションとして使用されます。このフィールドの値が設定されていないすべてのリソースにデフォルトオプションを設定するには、以下のリンクを使用してください。';
$lang["metadata_populate_default_node_for_empty_values"]='デフォルトオプションを設定する';
