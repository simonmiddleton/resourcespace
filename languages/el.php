...
$lang["admin_delete_field_confirm"]='Υπάρχουν %%AFFECTEDRESOURCES%% πόρος(-οι) με δεδομένα σε αυτό το πεδίο. Μερικά από τα επηρεαζόμενα αναγνωριστικά πόρων παρατίθενται παρακάτω. Τα μεταδεδομένα που σχετίζονται με αυτό το πεδίο θα χαθούν αν συνεχίσετε. Είστε σίγουροι ότι θέλετε να προχωρήσετε με τη διαγραφή;';
...
$lang["email_actions_truncated"]='Εμφανίζονται μόνο οι πιο πρόσφατες 1000 ενέργειες εδώ. Έχετε %%TOTAL%% ενέργειες. Συνδεθείτε στο %%APPLICATIONNAME%% για να τις δείτε όλες.';
