...
generateResourcesMetadataCSV($search_results,true, false,$tempcsv);
...
generateResourcesMetadataCSV($search_results,false, false,$tempcsv);
$csvh=fopen($tempcsv,"r");
while (($row = fgetcsv($csvh,5000)) !== false)
    {
    if(
...
generateResourcesMetadataCSV($search_results,false, true,$tempcsv);
$csvh=fopen($tempcsv,"r");
while (($row = fgetcsv($csvh,5000)) !== false)
    {
    if(
