...
?><div class="TopInpageNav">
    <div class="TopInpageNavLeft">
        ...
        if($per_page==99999)
            ...
            { 
            ?><a href="<?php echo $url; ?>&per_page_list=99999" onClick="return CentralSpaceLoad(this);"><?php echo escape($lang["all"])?></a><?php 
            } ?>
        </div> 
    </div>
    <?php pager(false); ?>
