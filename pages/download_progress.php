...
<div class="BasicsBox">
    ...
    <p style="font-weight:bold;"><?php echo LINK_CARET ?><a href="<?php echo escape($url); ?>"><?php echo escape($lang["rightclicktodownload"]); ?></a></p>
<?php } else { 
...
<?php } 
    ...
    <?php if (!hook("downloadfinishlinks"))
        {?>
        <p><a onClick="return CentralSpaceLoad(this,true);" href="<?php echo generateURL($baseurl_short . "pages/view.php",$url_parameters) ?>"><?php echo LINK_CARET_BACK ?><?php echo escape($lang["backtoresourceview"]); ?></a></p>
        <?php
        if(strpos($search,"!collection") !== false)
            {?>
            <p><a onClick="return CentralSpaceLoad(this,true);" href="<?php echo generateURL($baseurl_short . "pages/search.php", $url_parameters) ?>"><?php echo LINK_CARET_BACK ?><?php echo escape($lang["backtoresults"]); ?></a></p>
            <?php
            }

        if ($k=="")
            { ?>
            <p><a onClick="return CentralSpaceLoad(this,true);" href="<?php echo generateURL($baseurl_short  . "pages/home.php") ?>"><?php echo LINK_CARET_BACK ?><?php echo escape($lang["backtohome"]); ?></a></p>
            <?php
            }
        }?>
