...
<div class="BasicsBox"> 
  ...
  <div class="VerticalNav">
	<ul>
		...
		<li><i aria-hidden="true" class="fa fa-fw fa-filter"></i>&nbsp;<a href="<?php echo $baseurl_short?>pages/admin/admin_filter_manage.php" onclick="return CentralSpaceLoad(this,true);"><?php echo $lang["filters_manage"] ?></a></li>
