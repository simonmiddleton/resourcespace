  ...
  <h2><?php echo i18n_get_collection_name($tempcol)?></h2>
	...
	if ($download_usage && ((isset($zipcommand) || $collection_download) && $count_result>0)) { ?>
		...
		<a onclick="return CentralSpaceLoad(this,true);" 
		   href="<?php echo $baseurl_short . "pages/download_usage.php?collection=" . $usercollection . "&k=" . $k?>">
		   <?php echo LINK_CARET ?><?php echo $lang["action-download"]?></a>
	
	<?php } else if ((isset($zipcommand) || $collection_download) && $count_result>0) { ?>

	    <a onclick="return CentralSpaceLoad(this,true);" 
	       href="<?php echo $baseurl_short . "pages/collection_download.php?collection=" . $usercollection . "&k=" . $k?>"> 
	       <?php echo LINK_CARET ?><?php echo $lang["action-download"]?></a>
