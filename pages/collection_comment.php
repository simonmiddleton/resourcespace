...
<p><?php echo escape($lang["collectioncommentsinfo"]);render_help_link("user/resource_commenting");?></p>
<?php 
$imagepath = get_resource_path($ref,true,"col",false,"jpg");
$imageurl = get_resource_path($ref,false,"col",false,"jpg");
if (file_exists($imagepath)){?>
<div class="Question">
<label for="image"><?php echo escape($lang["preview"]); ?></label><img src="<?php echo $imageurl?>?nc=<?php echo time()?>" alt="" class="Picture" />
...
<div class="Question">
<label for="name"><?php echo escape($lang["rating"]); ?></label><select class="stdwidth" name="rating">
