...
<div class="backtoresults"> 
    ...
    if(!$modal)
        {?>
        <p><a href="<?php echo $backurl != "" ? generateURL(escape($backurl)) : $baseurl_short ."pages/team/team_request.php";?>" onClick="return CentralSpaceLoad(this,true);"><?php echo LINK_CARET_BACK ?><?php echo $backurl!=""?$lang["back"]:$lang["managerequestsorders"]; ?></a></p>
        <?php
        }
        ?>
