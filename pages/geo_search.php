...
<p><?php echo escape($lang["geographicsearch_help"]); render_help_link("user/geographic-search");?></p>
...
<div id="GeoDragMode">
    ...
    <input type="radio" name="dragmode" id="dragmodepan" onClick="map1.editTools.stopDrawing();" /><label for="dragmodepan"> <?php echo escape($lang['geodragmodepan']); ?></label>
        &nbsp;
    <input type="radio" name="dragmode" id="dragmodearea" checked="checked" onClick="map1.editTools.startRectangle();" /><label for="dragmodearea"><?php echo escape($lang['geodragmodeareaselect']); ?></label>
</div>
