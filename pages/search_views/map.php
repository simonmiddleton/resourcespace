                ...
                switch(rtype) {
                    ...
                    if(!isset($marker_metadata_field))
                        ...
                        foreach($maprestypes as $maprestype)
                            {
                            $markercolour = (isset($maprestype["colour"]) && $maprestype["colour"] > -1 && $maprestype["colour"] < count($MARKER_COLORS)) ? (int)$maprestype["colour"] : ($maprestype["ref"] % count($MARKER_COLORS));
                            echo "\n    case " . $maprestype["ref"] . ":\n";
