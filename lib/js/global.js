...
function ModalCentre()
	...
	if (modalalign=='right')
	    ...
	    {
	    modalheight=jQuery('.ui-layout-center').height() - 90;
	    modalwidth=1235;
	    }
    ...
    if (jQuery('#modal').height() > jQuery('.ui-layout-center').height() - 90) {
        modalheight = jQuery('.ui-layout-center').height() - 90;
        jQuery('#modal').css({	
            height: modalheight
        });
...
function headerLinksDropdown()
    {
    var containerWidth = jQuery("#HeaderLinksContainer").innerWidth() - 25;
...
function showHideLinks()
    {
    if (jQuery('#OverFlowLinks').css("display") == "none")
        {
        jQuery('#OverFlowLinks').css("display", "block");
        }
    else
        {
