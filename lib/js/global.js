    ...
    jQuery.ajax({
            ...
            async:false            
                ...
                if (browseopen.indexOf(browse_id)==-1)
                    ...
                    console.log('Opening browse node ' + browse_id);
                    SetCookie('browseopen',browseopen);
                    }
...
function ReloadBrowseBar()
    {
    var browseopen = jQuery.cookie("browseopen") ? jQuery.cookie("browseopen").split(/,/) : new Array();
...
//TODO Reload browse_bar function - call after page load if required and check cookies to reload bar and call to refresh after new restype/field/node/collection etc.