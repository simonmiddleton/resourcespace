...
function setSearchTagInput(search_input, delimiter, autocomplete_url)
    {
    var tags_input_options = {
        ...
        onChange: function(field, editor, tags) {
            // console.log('Tags changed to: ' + (tags.length ? tags.join(', ') : '----'));
            field[0].value = (tags.length ? tags.join(', ') : '');
        }
    };

    search_input.tagEditor(tags_input_options);
    }
