...
* 
*/
function new_featured_collection_category()
    {
    console.log("TODO: add client side logic based on new layout");
    return false;

    if(document.getElementById('newtheme<?php echo $themeindex?>').value=='')
        {
        alert('<?php echo $lang["collectionsnothemeselected"] ?>');
        return false;
        }

    document.getElementById('addlevel').value='yes';
