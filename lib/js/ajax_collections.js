...
function ToggleCollectionResourceSelection(e, collection)
    ...
    // @todo: make sure to support shift+ selecting range of resources (@see AddResourceToCollection/ RemoveResourceFromCollection)
    console.log("@todo: make sure to support shift+ selecting range of resources (@see AddResourceToCollection/ RemoveResourceFromCollection)");
