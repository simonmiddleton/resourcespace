...
/**
* Validate client side input and submit form for adding a new Featured Collection category
* 
* @param string input_id  The id of the input element that is used to send the new category name
* 
* @return boolean
*/
function new_featured_collection_category(input_id)
    {
    var input_el = document.getElementById(input_id);
    if(input_el.value == '')
        {
        alert(input_el.getAttribute("data-collectionsnothemeselected"));
        return false;
        }

    return CentralSpacePost(jQuery('#collectionform')[0]);
    }