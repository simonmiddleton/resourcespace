annotorious.plugin.RSTagging = function(opt_config_options)
    ...
    */
    // this.warn_tags_unsearchable = opt_config_options['warn_tags_unsearchable'];
    this.warn_tags_unsearchable = false;
    }
    ...
    jQuery.get(
        ...
        function (response)
            ...
            for(var key in response)
                {
                anno.addAnnotation(response[key]);
                }
            },
        'json'
    );
...
annotorious.plugin.RSTagging.prototype._extendPopup = function(annotator)
    ...
    annotator.popup.addField(function(annotation)
        ...
        for(var key in annotation.tags)
            {
            if(!self.warn_tags_unsearchable && annotation.tags[key].tag_searchable == '')
                {
                continue;
                }
